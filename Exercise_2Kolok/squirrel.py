...
# Change the moving and bouncing rate of the player squirrel.
#   The squirrel should move faster and bounce slower.

# Increase the time when the squirrel is invulnerable
#   and decrease the flashing interval (at present is set to 1/10th of second).

# Define two different CAMERASLACK constants.
#   One for x and another for y axis.
#   The distance for y axis should be smaller than that for the x axis.


# Change the values that define the minimal and maximal speed of squirrel moving.

# Increase the chance the enemy squirrel to change the speed and direction.

# Create three squirrels inside the camera view at the beginning of the game.

# Increase the camera area of the game to 960x480 pixels

# Introduce the possibility an enemy squirrels to bounce downwards
#   (the squirrel could bounce only in one direction only upwards or only downwards).
#   The direction is determined when creating an enemy squirrel.

# Change the logic of the game.
#   If the squirrel is hit by the larger animal it becomes smaller using the same
#   logic as for the getting bigger at the current game.
#   The game is over when the squirrel grows to the WINSIZE or LOSTSIZE.
...
def main():
    ...
    pygame.display.set_icon(pygame.image.load("Exercise_2Kolok/gameicon.png"))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption("Squirrel Eat Squirrel")
    BASICFONT = pygame.font.Font("freesansbold.ttf", 32)

    # load the image files
    L_SQUIR_IMG = pygame.image.load("Exercise_2Kolok/squirrel.png")
    R_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, True, False)
    GRASSIMAGES = []
    for i in range(1, 5):
        GRASSIMAGES.append(pygame.image.load("Exercise_2Kolok/grass%s.png" % i))
